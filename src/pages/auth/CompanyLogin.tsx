...
const CompanyLogin = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-neutral-600 mb-8">Sign in to your company account</p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            ...
            <Link to="/company/forgot-password" className="text-sm font-medium text-primary-600 hover:text-primary-700">
              Forgot password?
            </Link>
          </div>
          <input
      ...
      <div className="mt-8 text-center">
        <p className="text-sm text-neutral-600">
          ...
          <Link to="/company/register" className="font-medium text-primary-600 hover:text-primary-700">
            Register now
          </Link>
        </p>
      </div>
