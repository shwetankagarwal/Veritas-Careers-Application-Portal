  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-neutral-900 mb-2">Post New Job</h1>
        <p className="text-neutral-600">Create a new job listing to find the perfect candidate</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className={`
                  w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500
                  ${errors.experience ? 'border-error-500' : 'border-neutral-300'}
                `}
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className={`
                  w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500
                  ${errors.responsibilities ? 'border-error-500' : 'border-neutral-300'}
                `}
            ...
            <div className="md:col-span-2">
              <h3 className="text-lg font-medium text-neutral-800 mb-4">Salary Range (Optional)</h3>
